...
public class BookSheetAdapter implements ModelSheetAdapter<BookModel> {
    ...
    enum SheetFields implements ModelSetter<BookModel> {
        ...
        mc1Name(BookAttributes.mc1Name, true, BS.stringSetter(BS.ifNotNull((m, s) -> m.getMc1().setName(s)))),
        mc1Gender(BookAttributes.mc1Gender, true, BS.stringSetter(BS.ifNotNull((m, s) -> m.getMc1().setGender(s)))),
        mc1Pronouns(BookAttributes.mc1Pronouns, true, BS.stringSetter(BS.ifNotNull((m, s) -> m.getMc1().setPronouns(s)))),
        mc1Age(BookAttributes.mc1Age, true, BS.stringSetter(BS.ifNotNull((m, s) -> m.getMc1().setAge(s)))),
        mc1Profession(BookAttributes.mc1Profession, true, BS.stringSetter(BS.ifNotNull((m, s) -> m.getMc1().setProfession(s)))),
        mc1Attachment(BS.stringSetter(BS.ifNotNull((m, s) -> m.getMc1().setAttachment(s)))),
        mc2Name(BookAttributes.mc2Name, true, BS.stringSetter(BS.ifNotNull((m, s) -> m.getMc2().setName(s)))),
        mc2Gender(BookAttributes.mc2Gender, true, BS.stringSetter(BS.ifNotNull((m, s) -> m.getMc2().setGender(s)))),
        mc2Pronouns(BookAttributes.mc2Pronouns, true, BS.stringSetter(BS.ifNotNull((m, s) -> m.getMc2().setPronouns(s)))),
        mc2Age(BookAttributes.mc2Age, true, BS.stringSetter(BS.ifNotNull((m, s) -> m.getMc2().setAge(s)))),
        mc2Profession(BookAttributes.mc2Profession, true, BS.stringSetter(BS.ifNotNull((m, s) -> m.getMc2().setProfession(s)))),
