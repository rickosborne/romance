...
public enum BookAttributes implements EnumSchemaAttribute<BookModel> {
    ...
    mc1Name(b -> b.getMc1().getName(), (b, v) -> b.getMc1().setName(v), String.class),
    mc1Gender(b -> b.getMc1().getGender(), (b, v) -> b.getMc1().setGender(v), String.class),
    mc1Pronouns(b -> b.getMc1().getPronouns(), (b, v) -> b.getMc1().setPronouns(v), String.class),
    mc1Age(b -> b.getMc1().getAge(), (b, v) -> b.getMc1().setAge(v), String.class),
    mc1Profession(b -> b.getMc1().getProfession(), (b, v) -> b.getMc1().setProfession(v), String.class),
    mc2(BookModel::getMc2, null, BookModel.MainChar.class),
    mc2Name(b -> b.getMc2().getName(), (b, v) -> b.getMc2().setName(v), String.class),
    mc2Gender(b -> b.getMc2().getGender(), (b, v) -> b.getMc2().setGender(v), String.class),
    mc2Pronouns(b -> b.getMc2().getPronouns(), (b, v) -> b.getMc2().setPronouns(v), String.class),
    mc2Age(b -> b.getMc2().getAge(), (b, v) -> b.getMc2().setAge(v), String.class),
    mc2Profession(b -> b.getMc2().getProfession(), (b, v) -> b.getMc2().setProfession(v), String.class),
